...
additionals = [
    ...
    },
    {
        "questions": [
            ...
            "آیا تا به حال نظرات دیگران را در کارهات مد نظر قرار دادی؟",
            "آیا تا به حال در انجام کارهات به نظرات دیگران توجه کردی؟",
            " آیا تاکنون در انجام کارهات نظرات دیگران را در نظر گرفتی؟",
            " آیا تاکنون در انجام فعالیت‌هات، نظرات دیگران را در نظر گرفتی؟",
            "آیا تا به حال در کارهات به نظرات دیگران اهمیت دادی؟",
            "آیا تا به حال در کارهات به نظرات دیگران توجه کردی؟",
            "آیا تا به حال در فعالیت‌هات به نظرات دیگران توجه داشتی؟",
        ],
        "YES": [15],
        "NO": [15, 20],
    },
...
protocols = [
    ...
    [
        "الف: چند عبارت کوتاه را انتخاب کنید، به عنوان مثال، «تو فرزند زیبای من هستی» یا «عشقِ من». در حالی که به عکس یا آواتار شاد نگاه می کنید، آن را به آرامی، با صدای بلند، حداقل پنج بار بگویید. سپس آهنگ مورد علاقه خود را حداقل پنج بار بخوانید.",
...
additionalsـformal = [
    ...
    },
    {
        "questions": [
            ...
            "آیا تا به حال نظرات دیگران را در کارهایت مد نظر قرار داده‌ای؟",
            "آیا تا به حال در انجام کارهایت به نظرات دیگران توجه کرده‌ای؟",
            " آیا تاکنون در انجام کارهایت، نظرات دیگران را در نظر گرفته‌ای؟",
            " آیا تاکنون در انجام فعالیت‌هایت، نظرات دیگران را در نظر گرفته‌ای؟",
            "آیا تا به حال در کارهایت به نظرات دیگران اهمیت داده‌ای؟",
            "آیا تا به حال در کارهایت به نظرات دیگران توجه کرده‌ای؟",
            "آیا تا به حال در فعالیت‌هایت به نظرات دیگران توجه داشته‌ای؟",
        ],
        "YES": [15],
        "NO": [15, 20],
    },
